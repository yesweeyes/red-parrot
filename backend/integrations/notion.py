...
# CLIENT_ID = 'XXX'
# CLIENT_SECRET = 'XXX'
CLIENT_ID = '1f7d872b-594c-8083-8741-0037498de837'
CLIENT_SECRET = 'secret_9U16ue8iJMYA44xfqdu9AuBiKERrRsEL3P6CN82V2Hp'
...
def create_integration_item_metadata_object(
    ...
    last_modified_time = response_json.get('last_modified_time')
